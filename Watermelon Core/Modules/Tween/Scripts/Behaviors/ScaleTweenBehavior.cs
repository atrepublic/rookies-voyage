/*
 * ScaleTweenBehavior.cs
 * ------------------------------------------------------------
 * Transform의 localScale 값을 트위닝하여 오브젝트 크기를 애니메이션합니다.
 * • 시작 스케일(startValue) → 목표 스케일(endValue)으로 duration 시간 동안 보간
...
namespace Watermelon
{
    ...
    public class ScaleTweenBehavior : TweenBehavior<Transform, Vector3>
    {
        // TargetValue 프로퍼티 -------------------------------------------------
        /// <summary>
        /// Transform의 현재 localScale 값을 가져오거나 설정합니다.
        /// </summary>
        ...
        protected override void StartLoop(float delay)
        {
            ...
            // Transform.DOScale 확장 메서드로 트윈 생성
